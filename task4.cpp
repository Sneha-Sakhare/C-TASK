...
void mark_completed(task *ptr, int n)
{
    ...
    while (ptr != NULL)
    {
        if (num == n)
        {
            ptr->status = true;
            cout << endl
                 << "task# " << n << "has marked completed" << endl;
            return;
        }
        ptr = ptr->next;
        num += 1;
...
int main()
{
    ...
    while (ch == '1' || ch == '2' || ch == '3' || ch == '4')
    {
        ...
        else if (ch == '3')
        {
            int n;
            cout << endl
                 << "mark completed the task from the current view of list" << endl;
        ...
        else if (ch == '4')
        {
            int n;
            cout << endl
                 << "removing done from the current view of list" << endl;
